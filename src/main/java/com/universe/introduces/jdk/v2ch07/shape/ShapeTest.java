package com.universe.introduces.jdk.v2ch07.shape;
...
class ShapeComponent extends JComponent {
	 ...
	 * 
	 * @param aShapeMaker
	 *            a shape maker that defines a shape from a point set
	 */
...
/**
 * A shape maker can make a shape from a point set. Concrete subclasses must
 * return a shape in the makeShape method.
 */
abstract class ShapeMaker {
	 ...
	 * 
	 * @param aPointCount
	 *            the number of points needed to define this shape.
	 */
...
/**
 * Makes an arc contained in a bounding box with two given corner points, and
 * with starting and ending angles given by lines emanating from the center of
 * the bounding box and ending in two given points. To show the correctness of
 * the angle computation, the returned shape contains the arc, the bounding box,
 * and the lines.
 */
