package com.universe.introduces.jdk.v2ch08.chart2;
...
/**
 * A customizer for the chart bean that allows the user to edit all chart
 * properties in a single tabbed dialog.
 * 
...
public class ChartBeanCustomizer extends JTabbedPane implements Customizer {
	 ...
	 * 
	 * @param s
	 *            a string containing the numbers to be displayed, separated by
	 *            white space
	 */
	 ...
	 * 
	 * @param i
	 *            the new title position (ChartBean.LEFT, ChartBean.CENTER, or
	 *            ChartBean.RIGHT)
	 */
	 ...
	 * 
	 * @param b
	 *            true if graph and background color are inverted
	 */
