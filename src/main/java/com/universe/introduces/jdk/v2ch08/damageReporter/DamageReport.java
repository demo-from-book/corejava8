package com.universe.introduces.jdk.v2ch08.damageReporter;
...
/**
 * This class describes a vehicle damage report that will be saved and loaded
 * with the long-term persistence mechanism.
 * 
...
public class DamageReport {
	...
	public void drawDamage(Graphics2D g2) {
		...
		for (Point2D center : points) {
			Ellipse2D circle = new Ellipse2D.Double(center.getX() - MARK_SIZE, center.getY() - MARK_SIZE, 2 * MARK_SIZE,
					2 * MARK_SIZE);
			g2.draw(circle);
		}
	}
