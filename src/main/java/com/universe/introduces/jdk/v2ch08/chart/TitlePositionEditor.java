package com.universe.introduces.jdk.v2ch08.chart;

import java.beans.*;
import java.util.*;

/**
 * A custom editor for the titlePosition property of the ChartBean. The editor
 * lets the user choose between Left, Center, and Right
 * 
