package com.universe.introduces.jdk.v2ch12.win32reg;

import java.util.*;

/**
 * A Win32RegKey object can be used to get and set values of a registry key in
...
public class Win32RegKey {
	...
	/**
	 * Enumerates all names of registry entries under the path that this object
	 * describes.
	 * 
